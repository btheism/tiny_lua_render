...
NVCC_LIBRARY :=
C_LIBRARY := glad
CPP_LIBRARY := tiny_window tiny_shader tiny_texture tiny_mesh tiny_image tiny_linear tiny_framebuffer tiny_common
...
NVCC_TEST :=
C_TEST := 
CPP_TEST := glfw_callback glfw_getkey vao_vbo glm_matrix glm_calculator tiny_matrix_behavior
